            ...
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <select name="salon" id="salon" class="form-control">
                        <?php
                        $query_salon = mysqli_query($conexion, " select * from cliente ");
                        mysqli_close($conexion);
                        $resultado_salon = mysqli_num_rows($query_salon);
                        if ($resultado_ro > 0) {
                            while ($salon = mysqli_fetch_array($query_salon)) {
                        ?>
                                <option value="<?php echo $salon["id"]; ?>"><?php echo $salon["nombre"] ?></option>
                        <?php
