...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		<div class="sidebar-brand-icon rotate-n-15">
			<img src="img/F1TopPoin.jpg" class="img-thumbnail">
		</div>
		<div class="sidebar-brand-text mx-3">Prueba F1 Top Poin</div>
	</a>
	...
	<li class="nav-item">
		...
		<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="registro.php">Nuevo registro</a>
				<a class="collapse-item" href="lista_registros.php">Registros</a>
				<a class="collapse-item" href="archivo.php">Subir Archivo</a>
			</div>
		</div>
	</li>
